...
- (void)viewDidLoad
{
    ...
    [unbackedAuthorizeButton setFrame:CGRectMake(10, 260, 300, 40)];
    ...
    [unbackedBetButton setFrame:CGRectMake(10, 310, 300, 40)];
    ...
    /* Auth with uiwebview */
    inAppAuthButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    [inAppAuthButton setFrame:CGRectMake(10, 360, 300, 40)];
    [inAppAuthButton setTitle:@"In-App Authorization" forState:UIControlStateNormal];
    [[self view] addSubview:inAppAuthButton];
    [inAppAuthButton addTarget:self action:@selector(inAppAuth:)
                forControlEvents:(UIControlEvents)UIControlEventTouchDown];
